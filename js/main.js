...
function removeTransition(event) {
    if (currentAudio) document.querySelector('.key[data-key="' + event.keyCode + '"]').classList.remove('playing');
}
...
function playSound(event) {
    ...
    currentAudio = (document.querySelector('audio[data-key="' + key + '"]'))?document.querySelector('audio[data-key="' + key + '"]'):null;
